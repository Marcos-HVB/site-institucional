...
function cadastrar(req, res) {
    ...
    var nome = req.body.primeiroNomeServer;
    ...
    if (nome == undefined) {
        ...
        console.log('entrou nas validações usuariocontroller')
        ...
        usuarioModel.cadastrar(nome,sobrenome,cargo, email, senha,unidade)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
